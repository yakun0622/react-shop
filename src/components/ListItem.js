...
class ListItem extends Component {
    ...
    render() {
        ...
        const body = hasCheckbox ? this.createLabelElement(styles, contentChildren, other) :
        ...
        return (
            <div>
                {
                    this.props.linkTo ? <Link to={this.props.linkTo} >{body}</Link> : body
                }
                {nestedList}
            </div>
        );
